...
//  K-Map_Solver
//
//  Created by Garvit Chaudhary on 12/04/21.
//
...
int main(int argc, const char * argv[]) {
    ...
    printline();
    cout<<"Contributors:\nGarvit Chaudhary(2k19/co/137)\nDevender Kumar Pahadia(2k19/co/116)\n";
    printline();
    cout<<" ________________________________"<<endl
    <<    "|4-Variable K-Map Simplification |"<<endl
